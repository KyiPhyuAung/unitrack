...
<!-- Services Section -->
<section class="services section" data-aos="fade-up" data-aos-delay="50" id="services">
<div class="container" data-aos="fade-up" data-aos-delay="100">
<div class="row gy-4">
<div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
<div class="service-item">
<div class="service-image">
<img alt="Cardiology Services" class="img-fluid" src="{{ asset('unitrack-site/assets/img/health/cardiology-2.webp') }}"/>
...
<div class="service-item">
<div class="service-image">
<img alt="Neurology Services" class="img-fluid" src="{{ asset('unitrack-site/assets/img/health/neurology-3.webp') }}"/>
<div class="service-overlay">
...
<div class="service-item">
<div class="service-image">
<img alt="Orthopedics Services" class="img-fluid" src="{{ asset('unitrack-site/assets/img/health/orthopedics-1.webp') }}"/>
<div class="service-overlay">
...
<div class="service-item">
<div class="service-image">
<img alt="Pediatrics Services" class="img-fluid" src="{{ asset('unitrack-site/assets/img/health/pediatrics-4.webp') }}"/>
<div class="service-overlay">
...
<div class="service-item">
<div class="service-image">
<img alt="Emergency Services" class="img-fluid" src="{{ asset('unitrack-site/assets/img/health/emergency-2.webp') }}"/>
<div class="service-overlay">
...
<div class="service-item">
<div class="service-image">
<img alt="Laboratory Services" class="img-fluid" src="{{ asset('unitrack-site/assets/img/health/laboratory-3.webp') }}"/>
<div class="service-overlay">
