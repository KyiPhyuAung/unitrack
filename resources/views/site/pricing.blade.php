...
<!-- Appointmnet Section -->
<section class="appointmnet section" data-aos="fade-up" data-aos-delay="50" id="appointmnet">
...
<form action="forms/book-appointment.php" class="php-email-form" method="post">
<div class="row gy-4">
<div class="col-md-6">
...
<div class="col-12">
<textarea class="form-control" name="message" placeholder="Additional notes or symptoms (optional)" rows="4"></textarea>
</div>
<div class="col-12">
<div class="loading">Loading</div>
<div class="error-message"></div>
<div class="sent-message">Your appointment has been scheduled. Thank you!</div>
<button class="btn-book" type="submit">Book Appointment Now</button>
</div>
</div>
</form>
</div>
